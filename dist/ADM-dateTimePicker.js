            ...
            link: function(scope, element, attrs, ngModel) {
				...
				scope.$watch('model', function () {
					if(angular.isDefined(ngModel.$modelValue)){	
						scope.parseInputValue(ngModel.$modelValue || scope.option.default, true, false);
					}
				})
        ...
        .constant('constants', {
            calendars: {
                gregorian: {
                    ...
                    daysNames: ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sat']
                },
                jalali: {
